...
fun ListaTarefasScreen(
    ...
    ListaTarefasContent(
        ...
        onDeletar = { tarefa -> tarefaParaExcluir = tarefa },
...
fun ListaTarefasContent(
    ...
    tarefaParaExcluir?.let { tarefa ->
        AlertDialog(
            ...
            confirmButton = {
                TextButton(onClick = { onConfirmarExclusao(tarefa) }) { Text("Excluir") }
            },
            dismissButton = {
                TextButton(onClick = onCancelarExclusao) { Text("Cancelar") }
            }
        )
    }
